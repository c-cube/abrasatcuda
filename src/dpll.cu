...
__device__ __host__ 
inline void 
update_satisfied( atom_t *formula, atom_t *clauses_index, value_t *vars, satisfied_t *satisfied_clauses, unsigned int stack_depth, int clause_n, int var_n )
{
    // for each clause
